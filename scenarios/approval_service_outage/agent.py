from scenarios.approval_service_outage.agent_core import AgentCore, Mode, ModelClient
from scenarios.approval_service_outage.database import ScenarioDatabase
from scenarios.approval_service_outage.modes.hardened import HardenedPosture
from scenarios.approval_service_outage.modes.prompt_only import PromptOnlyPosture
from scenarios.approval_service_outage.modes.vulnerable import VulnerablePosture


class ApprovalOutageAgent:
